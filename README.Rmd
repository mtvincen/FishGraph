...
A comprehensive description of all included functions and examples of their graphical output is available in [**NOAA Technical Memorandum NMFS-SEFSC-XXXXX**](
`r noquote(system.file("doc/fishgraph-guide-DRAFT.pdf",package="FishGraph"))`
)
